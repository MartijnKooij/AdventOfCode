        ...
        static void Main(string[] args)
        {
            ...
            while (!found)
            {
                foreach (var change in inputs)
                {
                    ...
                    if (knownFrequencies.Any(x => x == frequency))
                    {
                        Console.WriteLine($"First duplicate found: {frequency}");
                        found = true;
                        break;
                    }
